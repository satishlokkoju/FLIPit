...
import com.vision.autosilent.R;
...
{
    private static final String changeString = "com.vision.autosilent.broadcast";
    ...
    {
        Intent intent = new Intent("com.vision.autoSilentService");
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        Log.i("AutoSilent","inside onRecieve of widget");
    ...
    private void changeRegister(Context context)
    {
        ...
        Intent changeIntent = new Intent("com.vision.autoSilentService");
        Bundle bundle = new Bundle();
